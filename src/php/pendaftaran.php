            ...
            <div class="row justify-content-center">
                <div class="ms-5 ps-5 me-5 pe-5 col-8">
                    <form action="" method="post" class="ms-5 ps-5 me-5 pe-5" enctype="multipart/form-data">
                        ...
                        <input type="text" id="nama" name="nama" class="form-control mb-3" placeholder="Reza Rahadian">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" id="email" name="email" class="form-control mb-3" placeholder="testing@gmail.com">
                        <label for="telepon" class="form-label">No. Telepon</label>
                        <input type="tel" id="telepon" name="telepon" class="form-control mb-3" placeholder="08xx-xxxx-xxxx">
                        <label for="JK" class="form-label">Jenis Kelamin</label>
                        <select name="JK" name="JK" id="JK" class="form-select mb-3" aria-label="Default select example">
                            <option value="laki-laki">Laki-Laki</option>
                            <option value="perempuan">Perempuan</option>
                        </select>
                        <label for="tmpt" class="form-label">Tempat Lahir</label>
                        <input type="text" name="tmpt" id="tmpt" class="form-control mb-3" placeholder="Malang">
                        <label for="date" class="form-label">Tanggal Lahir</label>
                        <input type="date" name="date" id="date" class="form-control mb-3">
                        <label for="domisili" class="form-label">Domisili</label>
                        <input type="text" name="domisili" id="domisili" class="form-control mb-3" placeholder="Surabaya">
                        <label for="nik" class="form-label">nik</label>
                        <input type="text" name="nik" id="nik" class="form-control mb-3" placeholder="nik">
                        <label for="pasfoto" class="form-label">Pasfoto</label>
                        <input type="file" name="pasfoto" class="form-control mb-3" id="pasfoto">
                        <label for="foto-ktp" class="form-label">Upload Foto KTP</label>
                        <input type="file" name="foto-ktp" class="form-control mb-3" id="foto-ktp">
                        <label for="file-pendukung" class="form-label">Upload File Pendukung</label>
                        <input type="file" name="file-pendukung" class="form-control mb-3" id="file-pendukung">
                        <button type="submit" name="submit" class="btn btn-primary button mt-3">Daftar</button>
                    </form>
                </div>
            </div>
        </div>
